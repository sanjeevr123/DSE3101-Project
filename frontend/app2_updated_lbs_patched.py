...
def step_5_results():
    return html.Div([
        ...
        html.Div([
            ...
            html.Div([
                html.Div(id="lbs_results_summary_slot"),
...
@app.callback(
    Output("lbs_results_summary_slot", "children"),
    Input("lbs_result", "data"),
)
def render_lbs_results_summary(lbs_result):
    return build_results_lbs_summary(lbs_result, card_style)
...
def run_results(n, sell_payload, sell_geo, sell_pred, prefs_w, constraints, lbs_result):
    ...
    for i, r in enumerate(recs, start=1):
        ...
        cards.append(html.Div([
            ...
            build_lbs_card_block(r, lbs_result),
            # MEMBER 8: distance
